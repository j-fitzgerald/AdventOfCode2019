...
/*
    public void setupSample(){
        ...
        greenWire.moveUp(7);
        greenWire.moveRight(6);
        greenWire.moveDown(4    );
        greenWire.moveLeft(4);
    ...
    public void sampleTest(){
        setupSample();
        int result = WireCompare.compareHash(redWire, greenWire);
        assertEquals(6, result);
    }

    @Test
    public void sample2DTest(){
        setupSample();
        int result = WireCompare.compare2d(redWire, greenWire);
        assertEquals(6, result);
    }

    @Test
    public void sampleParse2DTest(){
        StringParse.getArr(redSample, redWire);
        StringParse.getArr(greenSample, greenWire);
        int result = WireCompare.compare2d(redWire, greenWire);
        assertEquals(6, result);
    }
    ...
    public void sample2(){
        ...
        Point resultPoint = WireCompare.resultPoint;
        System.out.println(resultPoint);
        assertTrue(redWire.as2d[resultPoint.x][resultPoint.y]);
        assertTrue(greenWire.as2d[resultPoint.x][resultPoint.y]);
    }

    public void setupSample2(){
        StringParse.getArr(red, redWire);
        StringParse.getArr(green, greenWire);
    }*/

/*
    @Test
    public void actualTest(){
        StringParse.getArr(aR, redWire);
        StringParse.getArr(aG, greenWire);
        int result = WireCompare.compare2d(redWire, greenWire);
        System.out.println(result);
        Point resultPoint = WireCompare.resultPoint;
        System.out.println(resultPoint);
...
*/
    ...
    @Test
    public void actualStepsTest(){
        int result = 100000;
        int min = 10000;
        boolean t = true;
        StringParse.STEPS = 30000;
        while (StringParse.STEPS < 36000){
            try {
                t = false;
                redWire = new Wire();
                greenWire = new Wire();
                StringParse.getArr(aR, redWire);
                StringParse.getArr(aG, greenWire);
                result = WireCompare.compare2dSteps(redWire, greenWire);
                System.out.println(result);
                Point resultPoint = WireCompare.resultPoint;
                System.out.println(resultPoint);
                assertTrue(redWire.as2d[resultPoint.x][resultPoint.y].steps != 0);
                assertTrue(greenWire.as2d[resultPoint.x][resultPoint.y].steps != 0);
                StringParse.STEPS += 1000;
                if (result < min){ min = result;}
            } catch (NullPointerException e) {
                System.out.println("Failed " + StringParse.STEPS);
                StringParse.STEPS += 1000;
                t = true;
            }
    ...
    @Test
    public void actualStepsHashTest(){
        WireHash redWire = new WireHash();
        WireHash greenWire = new WireHash();
        StringParse.getArr(aR, redWire);
        StringParse.getArr(aG, greenWire);
        int result = WireCompare.compare2dHashSteps(redWire, greenWire);
        System.out.println(result);
        Point resultPoint = WireCompare.resultPoint;
        System.out.println(resultPoint);
//        assertTrue(redWire.as2d[resultPoint.x][resultPoint.y].steps != 0);
//        assertTrue(greenWire.as2d[resultPoint.x][resultPoint.y].steps != 0);
    ...
    @Test
    public void stepsSample2(){
        boolean t = true;
        while (t) {
            try {
                t = false;
                StringParse.STEPS += 200;
                redWire = new Wire();
                greenWire = new Wire();
                String r = "R75,D30,R83,U83,L12,D49,R71,U7,L72";
                String g = "U62,R66,U55,R34,D71,R55,D58,R83";
                StringParse.getArr(r, redWire);
                StringParse.getArr(g, greenWire);
                int result = WireCompare.compare2dSteps(redWire, greenWire);
                System.out.println(result);
                Point resultPoint = WireCompare.resultPoint;
                System.out.println(resultPoint);
                assertTrue(redWire.as2d[resultPoint.x][resultPoint.y].steps != 0);
                ...
                System.out.println(redWire.steps);
                System.out.println(greenWire.steps);
            }
            catch (Exception e){
                t = true;
            }
        ...
        System.out.println("required: " + StringParse.STEPS);
    }

    @Test
    public void stepsSample3(){
        boolean t = true;
        while (t) {
            try {
                t = false;
                redWire = new Wire();
                greenWire = new Wire();
                String r = "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51";
                String g = "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7";
                StringParse.getArr(r, redWire);
                StringParse.getArr(g, greenWire);
                int result = WireCompare.compare2dSteps(redWire, greenWire);
                System.out.println(result);
                ...
                assertTrue(redWire.as2d[resultPoint.x][resultPoint.y].steps != 0);
                assertTrue(greenWire.as2d[resultPoint.x][resultPoint.y].steps != 0);
                assertEquals(result, 410);
                System.out.println(redWire.steps);
                System.out.println(greenWire.steps);
            }
            catch (Exception e){
                System.out.println("Failed with " + StringParse.STEPS);
                StringParse.STEPS += 200;
                t = true;
            }
