...
public class OpsTests {
    ...
    public void testCode(){
        ...
        mem.makeOps();
        assertTrue(equal(new int[]{2,0,0,0,99},(Memory.opsList)));
    }
    ...
    public void testCodeTwo(){
        ...
        mem.makeOps();
        assertTrue(equal(new int[]{2,3,0,6,99},(Memory.opsList)));
    }
    ...
    public void testCodeThree(){
        ...
        mem.makeOps();
        assertTrue(equal(new int[]{2,4,4,5,99,9801}, (Memory.opsList)));
    }
    ...
    public void testCodeFour(){
        ...
        mem.makeOps();
        assertTrue(equal(new int[]{30,1,1,4,2,5,6,0,99}, (Memory.opsList)));
    ...
    public void testCodeFive(){
        ...
        assertTrue(equal(new int[]{3500,9,10,70,
                2,3,11,0,
                99,
                30,40,50}, (Memory.opsList)));
        System.out.println(Memory.opsList[0].toString());
    }
    ...
    public void testCode6(){
        ...
        mem.makeOps();
        assertTrue(equal(new int[]{5,1,1,5,2,2,3,0,99}, (Memory.opsList)));
        System.out.println(Memory.opsList[0].toString());
    }
    ...
    public void testCodeAlarm(){
        ...
        try {
            ...
            System.out.println("Expect Alarm + state0-- " + Memory.opsList[0]);
            System.out.println(e.getMessage());
            return;
        }
        System.out.println("No Alarm " + Memory.opsList[0]);
        System.out.println("No Alarm " + Memory.opsList[0].valString());
    ...
    public void testCodeAlarmX(){
        ...
        System.out.println("No Alarm " + Memory.opsList[0]);
        assertEquals(19690720, Memory.opsList[0].getValue());
    ...
    public void testCodeZZZ(){
        for (int i = 0; i < 100; i++) {
            for (int j = 0; j < 100; j++) {
                ...
                try {
                    mem.makeOps();
                    if (Memory.opsList[0].getValue() == 19690720){
                        System.out.println(i + "\t" + j);
//                        fail();
                        System.out.println(i*100 + j + ":\t\t" + Memory.opsList[0].toString());
                    }
                } catch (Exception e) {
